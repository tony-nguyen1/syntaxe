...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_22_ = 22,                       /* '/'  */
  YYSYMBOL_23_ = 23,                       /* '%'  */
  YYSYMBOL_MOINSUNAIRE = 24,               /* MOINSUNAIRE  */
  YYSYMBOL_25_ = 25,                       /* '^'  */
  YYSYMBOL_26_n_ = 26,                     /* '\n'  */
  YYSYMBOL_27_ = 27,                       /* '('  */
  YYSYMBOL_28_ = 28,                       /* ')'  */
  YYSYMBOL_YYACCEPT = 29,                  /* $accept  */
  YYSYMBOL_liste = 30,                     /* liste  */
  YYSYMBOL_ligne = 31,                     /* ligne  */
...
{
       0,    18,    18,    19,    22,    23,    24,    35,    36,    51,
      52,    53,    54,    55,    60,    61,    64,    65,    66,    67,
      68,    71,    72
};
#endif
...
static const char *const yytname[] =
{
  ...
  "COS", "EXP", "LN", "PI", "QUIT", "HELP", "AND", "OR", "IMP", "EQU",
  "OUX", "NO", "T", "B", "'+'", "'-'", "'*'", "'/'", "'%'", "MOINSUNAIRE",
...
{
     -25,     0,   -25,   -24,   -25,    -5,    -3,     6,     7,   -25,
      10,    22,     8,   -25,     8,   -25,    74,   -25,     8,     8,
       8,     8,   -25,   -25,    25,    24,     8,     8,     8,     8,
       8,     8,   -25,    34,    44,    54,    64,   -25,    -4,    -4,
...
static const yytype_int8 yytable[] =
{
      ...
      11,     4,     5,     6,     7,     8,     9,    28,    29,    30,
      12,    31,    18,    24,    19,    25,    13,    14,    12,    33,
      34,    35,    36,    20,    21,    14,    22,    38,    39,    40,
      41,    42,    43,    26,    27,    28,    29,    30,    23,    31,
      31,     0,    37,    26,    27,    28,    29,    30,     0,    31,
       0,     0,    44,    26,    27,    28,    29,    30,     0,    31,
       0,     0,    45,    26,    27,    28,    29,    30,     0,    31,
       0,     0,    46,    26,    27,    28,    29,    30,     0,    31,
       0,     0,    47,    26,    27,    28,    29,    30,     0,    31,
      32
};

static const yytype_int8 yycheck[] =
{
       0,     1,    26,     3,     4,     5,     6,     7,     8,     9,
      10,     3,     4,     5,     6,     7,     8,    21,    22,    23,
      20,    25,    27,    12,    27,    14,    26,    27,    20,    18,
      19,    20,    21,    27,    27,    27,    26,    26,    27,    28,
      29,    30,    31,    19,    20,    21,    22,    23,    26,    25,
      25,    -1,    28,    19,    20,    21,    22,    23,    -1,    25,
      -1,    -1,    28,    19,    20,    21,    22,    23,    -1,    25,
      -1,    -1,    28,    19,    20,    21,    22,    23,    -1,    25,
      -1,    -1,    28,    19,    20,    21,    22,    23,    -1,    25,
      -1,    -1,    28,    19,    20,    21,    22,    23,    -1,    25,
      26
...
static const yytype_int8 yystos[] =
{
       ...
       9,    10,    20,    26,    27,    31,    32,    26,    27,    27,
      27,    27,    26,    26,    32,    32,    19,    20,    21,    22,
      23,    25,    26,    32,    32,    32,    32,    28,    32,    32,
...
#line 24 "calc.y"
            {if (!errSemantiq) 
				printf("Résultat : %10.2f\n",yyvsp[-1]); /* 10 car dont 2décimales */
